...
?>
<div class="contact<?php echo $this->pageclass_sfx?> contact-tabs contact-slide row">

<?php if($this->params->get('presentation_style') == 'plain') : ?>
<div id="contact-plain">
<div class="col-sm-6">
    ...
    <div class="thumbnail pull-right col-sm-12">
...
<?php endif;?>
	...
	<?php endif; ?>
	<?php if ($this->contact->name && $this->params->get('show_name') && $this->params->get('presentation_style')!='plain') : ?>
