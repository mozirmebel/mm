...
<script type="text/javascript">
	...
	function contentSliderInit_<?php echo $module->id;?> (cid) {
		...
		if (windowsize.x > <?php echo $xwidth; ?>) {
...
<div id="ja-contentslider-<?php echo $module->id;?>" class="ja-contentslider<?php echo $params->get( 'moduleclass_sfx' );?> clearfix" >
  ...
  <div class="ja-btn-control">
		...
		<?php if ($mode == 'vertical'){ ?>
			<div class="ja-contentslide-left-img ja-contentslide-up-img slide-control next up" title="<?php echo JText::_('NEXT'); ?>"><i class="fa fa-angle-up"></i></div>
			<div class="ja-contentslide-right-img ja-contentslide-down-img slide-control prev down" title="<?php echo JText::_('PREVIOUS'); ?>"><i class="fa fa-angle-down"></i></div>
		<?php } else {?>
			<div class="ja-contentslide-left-img slide-control next" title="<?php echo JText::_('NEXT'); ?>">
			...
			<div class="ja-contentslide-right-img slide-control prev" title="<?php echo JText::_('PREVIOUS'); ?>">
				<?php if($lang->isRTL() == 1) { ?>
					<i class="fa fa-angle-left"></i>
				<?php } else { ?>
					<i class="fa fa-angle-right"></i>
